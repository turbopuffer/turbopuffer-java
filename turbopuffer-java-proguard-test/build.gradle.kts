...
dependencies {
    testImplementation(project(":turbopuffer-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../turbopuffer-java-core/src/main/resources/META-INF/proguard/turbopuffer-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.turbopuffer.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../turbopuffer-java-core/src/main/resources/META-INF/proguard/turbopuffer-java-core.pro",
