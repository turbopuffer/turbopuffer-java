...
[![Maven Central](https://img.shields.io/maven-central/v/com.turbopuffer/turbopuffer-java)](https://central.sonatype.com/artifact/com.turbopuffer/turbopuffer-java/2.0.0-alpha.5)
[![javadoc](https://javadoc.io/badge2/com.turbopuffer/turbopuffer-java/2.0.0-alpha.5/javadoc.svg)](https://javadoc.io/doc/com.turbopuffer/turbopuffer-java/2.0.0-alpha.5)
...
The REST API documentation can be found on [turbopuffer.com](https://turbopuffer.com/docs/auth). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.turbopuffer/turbopuffer-java/2.0.0-alpha.5).
...
```kotlin
implementation("com.turbopuffer:turbopuffer-java:2.0.0-alpha.5")
```
