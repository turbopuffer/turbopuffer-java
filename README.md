...
[![Maven Central](https://img.shields.io/maven-central/v/com.turbopuffer/turbopuffer-java)](https://central.sonatype.com/artifact/com.turbopuffer/turbopuffer-java/1.1.0)
[![javadoc](https://javadoc.io/badge2/com.turbopuffer/turbopuffer-java/1.1.0/javadoc.svg)](https://javadoc.io/doc/com.turbopuffer/turbopuffer-java/1.1.0)
...
The REST API documentation can be found on [turbopuffer.com](https://turbopuffer.com/docs/auth). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.turbopuffer/turbopuffer-java/1.1.0).
...
```kotlin
implementation("com.turbopuffer:turbopuffer-java:1.1.0")
```
