...
[![Maven Central](https://img.shields.io/maven-central/v/com.turbopuffer.api/turbopuffer-java)](https://central.sonatype.com/artifact/com.turbopuffer.api/turbopuffer-java/0.1.0-beta.1)
...
```kotlin
implementation("com.turbopuffer.api:turbopuffer-java:0.1.0-beta.1")
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/turbopuffer/turbopuffer-java-2/issues) with questions, bugs, or suggestions.
