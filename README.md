...
<a href="https://central.sonatype.com/artifact/com.turbopuffer/turbopuffer-java/0.1.0-beta.14"><img src="https://img.shields.io/maven-central/v/com.turbopuffer/turbopuffer-java" alt="Go Reference" align="right"></a>
<a href="https://javadoc.io/doc/com.turbopuffer/turbopuffer-java/0.1.0-beta.14"><img src="https://javadoc.io/badge2/com.turbopuffer/turbopuffer-java/0.1.0-beta.14/javadoc.svg" alt="Go Reference" align="right"></a>
...
The REST API documentation can be found on [turbopuffer.com](https://turbopuffer.com/docs/auth). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.turbopuffer/turbopuffer-java/0.1.0-beta.14).
...
```kotlin
implementation("com.turbopuffer:turbopuffer-java:0.1.0-beta.14")
```
