...
[![Maven Central](https://img.shields.io/maven-central/v/com.turbopuffer.api/turbopuffer-java)](https://central.sonatype.com/artifact/com.turbopuffer.api/turbopuffer-java/0.1.0-alpha.2)
...
```kotlin
implementation("com.turbopuffer.api:turbopuffer-java:0.1.0-alpha.2")
```
