...
[![Maven Central](https://img.shields.io/maven-central/v/com.turbopuffer/turbopuffer-java)](https://central.sonatype.com/artifact/com.turbopuffer/turbopuffer-java/2.2.0-alpha.1)
[![javadoc](https://javadoc.io/badge2/com.turbopuffer/turbopuffer-java/2.2.0-alpha.1/javadoc.svg)](https://javadoc.io/doc/com.turbopuffer/turbopuffer-java/2.2.0-alpha.1)
...
The REST API documentation can be found at [turbopuffer.com/docs/overview](https://turbopuffer.com/docs/overview). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.turbopuffer/turbopuffer-java/2.2.0-alpha.1).
...
```kotlin
implementation("com.turbopuffer:turbopuffer-java:2.2.0-alpha.1")
```
...
transparently decompressed by OkHttp, set the `compression` option to `true`:

```java
TurbopufferClient compressedClient = TurbopufferOkHttpClient.builder()
    .fromEnv()
    .compression(true)
    .build();
```
...
```java
TurbopufferClient clientWithOptions = client.withOptions(opts -> opts.compression(true));
```

Request bodies are never compressed unless you add a custom interceptor.
...
JsonField<BranchFromNamespaceParams> branchFromNamespace = client.namespace("ns").write(params)._branchFromNamespace();
