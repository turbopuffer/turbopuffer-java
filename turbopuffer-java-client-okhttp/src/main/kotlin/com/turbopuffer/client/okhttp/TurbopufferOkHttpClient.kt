...
package com.turbopuffer.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.turbopuffer.client.TurbopufferClient
import com.turbopuffer.client.TurbopufferClientImpl
...
/**
 * A class that allows building an instance of [TurbopufferClient] with [OkHttpClient] as the
...
class TurbopufferOkHttpClient private constructor() {
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TurbopufferClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): TurbopufferClient = builder().fromEnv().build()
    }

    /** A builder for [TurbopufferOkHttpClient]. */
