package com.turbopuffer.api.client.okhttp
...
import com.turbopuffer.api.core.http.HttpClient
import com.turbopuffer.api.core.http.HttpMethod
import com.turbopuffer.api.core.http.HttpRequest
import com.turbopuffer.api.core.http.HttpRequestBody
import com.turbopuffer.api.core.http.HttpResponse
import com.turbopuffer.api.errors.TurbopufferIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(TurbopufferIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("TURBOPUFFER_LOG")?.lowercase()) {
