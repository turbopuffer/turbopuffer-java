...
class NamespaceServiceAsyncTest {
    ...
    @Test
    fun list() {
      val client = TurbopufferOkHttpClientAsync.builder()
    ...
    fun deleteAll() {
      ...
      val responseFuture = namespaceServiceAsync.deleteAll(NamespaceDeleteAllParams.builder()
          .namespace("namespace")
          .build())
    ...
    fun getSchema() {
      ...
      val responseFuture = namespaceServiceAsync.getSchema(NamespaceGetSchemaParams.builder()
          .namespace("namespace")
          .build())
    ...
    fun query() {
      ...
      val documentRowWithScoresFuture = namespaceServiceAsync.query(NamespaceQueryParams.builder()
          .namespace("namespace")
    ...
    fun upsert() {
      ...
      val responseFuture = namespaceServiceAsync.upsert(NamespaceUpsertParams.builder()
          .namespace("namespace")
