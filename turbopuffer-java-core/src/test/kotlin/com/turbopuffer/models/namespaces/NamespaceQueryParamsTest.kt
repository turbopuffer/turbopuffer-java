...
internal class NamespaceQueryParamsTest {
    ...
    fun create() {
        NamespaceQueryParams.builder()
            ...
            .addGroupBy(JsonValue.from(mapOf<String, Any>()))
    ...
    fun body() {
        ...
        assertThat(body.groupBy().getOrNull()).containsExactly(JsonValue.from(mapOf<String, Any>()))
        assertThat(body.includeAttributes()).contains(IncludeAttributes.ofBool(true))
        assertThat(body.limit()).contains(NamespaceQueryParams.Limit.ofInteger(0L))
