...
class NamespaceUpsertParamsTest {
    ...
    @Test
    fun body() {
      val params = NamespaceUpsertParams.builder()
          .namespace("namespace")
          .documents(NamespaceUpsertParams.Documents.UpsertColumnar.builder()
              .attributes(DocumentColumns.Attributes.builder()
                  .putAdditionalProperty("foo", JsonValue.from(listOf(mapOf("foo" to "bar"))))
      ...
      assertThat(body).isEqualTo(NamespaceUpsertParams.Documents.ofUpsertColumnar(NamespaceUpsertParams.Documents.UpsertColumnar.builder()
          .attributes(DocumentColumns.Attributes.builder()
              .putAdditionalProperty("foo", JsonValue.from(listOf(mapOf("foo" to "bar"))))
              .build())
          .addId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
