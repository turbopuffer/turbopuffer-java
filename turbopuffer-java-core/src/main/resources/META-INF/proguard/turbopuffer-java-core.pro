...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.turbopuffer.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.turbopuffer.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.turbopuffer.** {
    <init>(...);
