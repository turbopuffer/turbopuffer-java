...
sealed class Expr() {
    companion object {
        ...
        @JvmStatic
        public fun vectorDist(attr: String, value: List<Float>): ExprVectorDist =
            ExprVectorDist.create(attr, value)

        @JvmStatic public fun highlight(attr: String): ExprHighlight = ExprHighlight.create(attr)

        @JvmStatic
        public fun highlight(attr: String, config: HighlightConfigParams): ExprHighlightWithConfig =
            ExprHighlightWithConfig.create(attr, config)
    }
...
@JsonFormat(shape = JsonFormat.Shape.ARRAY)
@JsonPropertyOrder("f0", "attr")
class ExprHighlight private constructor(attr: String) : Expr() {
    ...
    companion object {
        @JvmSynthetic internal fun create(attr: String): ExprHighlight = ExprHighlight(attr)
    }
}
...
class ExprHighlightWithConfig private constructor(attr: String, config: HighlightConfigParams) :
    Expr() {
    private val f0: String = "Highlight"
    private val attr: String = attr
    ...
    companion object {
        @JvmSynthetic
        internal fun create(attr: String, config: HighlightConfigParams): ExprHighlightWithConfig =
            ExprHighlightWithConfig(attr, config)
    }
}
...
class ExprVectorDist private constructor(attr: String, value: List<Float>) : Expr() {
    private val attr: String = attr
    ...
    companion object {
        @JvmSynthetic
        internal fun create(attr: String, value: List<Float>): ExprVectorDist =
            ExprVectorDist(attr, value)
    }
}
