...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NamespaceMetadataParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [NamespaceMetadataParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NamespaceMetadataParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namespaceMetadataParams: NamespaceMetadataParams) = apply {
            namespace = namespaceMetadataParams.namespace
            additionalHeaders = namespaceMetadataParams.additionalHeaders.toBuilder()
            additionalQueryParams = namespaceMetadataParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NamespaceMetadataParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NamespaceMetadataParams =
