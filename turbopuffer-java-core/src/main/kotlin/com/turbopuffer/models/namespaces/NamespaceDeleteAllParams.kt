...
/** Delete namespace. */
class NamespaceDeleteAllParams private constructor(
    ...
    @JvmSynthetic
    internal fun _body(): Optional<Map<String, JsonValue>> = Optional.ofNullable(additionalBodyProperties.ifEmpty { null })
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namespaceDeleteAllParams: NamespaceDeleteAllParams) =
            apply {
                ...
                additionalBodyProperties = namespaceDeleteAllParams.additionalBodyProperties.toMutableMap()
            }
    ...
    override fun toString() = "NamespaceDeleteAllParams{namespace=$namespace, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
