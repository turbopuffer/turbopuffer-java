...
@NoAutoDetect
class NamespaceUpsertResponse @JsonCreator private constructor(
    ...
    fun validate(): NamespaceUpsertResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namespaceUpsertResponse: NamespaceUpsertResponse) =
            apply {
    ...
    override fun toString() = "NamespaceUpsertResponse{status=$status, additionalProperties=$additionalProperties}"
}
