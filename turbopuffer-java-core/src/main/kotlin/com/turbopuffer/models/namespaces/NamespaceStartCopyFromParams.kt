 ...
 */
class NamespaceStartCopyFromParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NamespaceStartCopyFromParams].
         *
    ...
    /** A builder for [NamespaceStartCopyFromParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namespaceStartCopyFromParams: NamespaceStartCopyFromParams) = apply {
            namespace = namespaceStartCopyFromParams.namespace
            body = namespaceStartCopyFromParams.body.toBuilder()
            additionalHeaders = namespaceStartCopyFromParams.additionalHeaders.toBuilder()
            additionalQueryParams = namespaceStartCopyFromParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NamespaceStartCopyFromParams].
         *
         ...
         */
        fun build(): NamespaceStartCopyFromParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NamespaceStartCopyFromParams &&
    ...
    override fun toString() =
        "NamespaceStartCopyFromParams{namespace=$namespace, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
