...
@NoAutoDetect
class DocumentRow @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(documentRow: DocumentRow) =
            apply {
                id = documentRow.id
    ...
    override fun toString() = "DocumentRow{id=$id, attributes=$attributes, vector=$vector, additionalProperties=$additionalProperties}"
}
