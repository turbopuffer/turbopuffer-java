...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WriteBilling && billableLogicalBytesWritten == other.billableLogicalBytesWritten && query == other.query && additionalProperties == other.additionalProperties /* spotless:on */
    }
