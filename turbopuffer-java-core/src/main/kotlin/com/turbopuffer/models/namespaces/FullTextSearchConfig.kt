...
@NoAutoDetect
class FullTextSearchConfig @JsonCreator private constructor(
    @JsonProperty("case_sensitive") @ExcludeMissing private val caseSensitive: JsonField<Boolean> = JsonMissing.of(),
    @JsonProperty("language") @ExcludeMissing private val language: JsonField<Language> = JsonMissing.of(),
    @JsonProperty("remove_stopwords") @ExcludeMissing private val removeStopwords: JsonField<Boolean> = JsonMissing.of(),
    @JsonProperty("stemming") @ExcludeMissing private val stemming: JsonField<Boolean> = JsonMissing.of(),
     ...
     * case-insensitive).
     */
    fun caseSensitive(): Optional<Boolean> = Optional.ofNullable(caseSensitive.getNullable("case_sensitive"))
     ...
     * remove common words).
     */
    fun removeStopwords(): Optional<Boolean> = Optional.ofNullable(removeStopwords.getNullable("remove_stopwords"))
    ...
    @ExcludeMissing
    fun _stemming(): JsonField<Boolean> = stemming
    ...
    fun validate(): FullTextSearchConfig =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fullTextSearchConfig: FullTextSearchConfig) =
            apply {
         ...
         * case-insensitive).
         */
        fun caseSensitive(caseSensitive: JsonField<Boolean>) =
            apply {
        ...
        /** The language of the text. Defaults to `english`. */
        fun language(language: JsonField<Language>) =
            apply {
         ...
         * remove common words).
         */
        fun removeStopwords(removeStopwords: Boolean) = removeStopwords(JsonField.of(removeStopwords))

        /**
         * Removes common words from the text based on language. Defaults to `true` (i.e.
         * remove common words).
         */
        fun removeStopwords(removeStopwords: JsonField<Boolean>) =
            apply {
         ...
         * stem).
         */
        fun stemming(stemming: JsonField<Boolean>) =
            apply {
    ...
    /** The language of the text. Defaults to `english`. */
    class Language @JsonCreator private constructor(
    ...
    override fun toString() = "FullTextSearchConfig{caseSensitive=$caseSensitive, language=$language, removeStopwords=$removeStopwords, stemming=$stemming, additionalProperties=$additionalProperties}"
}
