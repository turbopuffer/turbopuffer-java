...
class NamespaceCopyFromResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NamespaceCopyFromResponse].
         *
    ...
    /** A builder for [NamespaceCopyFromResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namespaceCopyFromResponse: NamespaceCopyFromResponse) = apply {
            billing = namespaceCopyFromResponse.billing
            message = namespaceCopyFromResponse.message
            rowsAffected = namespaceCopyFromResponse.rowsAffected
            status = namespaceCopyFromResponse.status
            deletedIds = namespaceCopyFromResponse.deletedIds.map { it.toMutableList() }
            patchedIds = namespaceCopyFromResponse.patchedIds.map { it.toMutableList() }
            performance = namespaceCopyFromResponse.performance
            rowsDeleted = namespaceCopyFromResponse.rowsDeleted
            rowsPatched = namespaceCopyFromResponse.rowsPatched
            rowsRemaining = namespaceCopyFromResponse.rowsRemaining
            rowsUpserted = namespaceCopyFromResponse.rowsUpserted
            upsertedIds = namespaceCopyFromResponse.upsertedIds.map { it.toMutableList() }
            additionalProperties = namespaceCopyFromResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NamespaceCopyFromResponse].
         *
         ...
         */
        fun build(): NamespaceCopyFromResponse =
    ...
    fun validate(): NamespaceCopyFromResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NamespaceCopyFromResponse &&
