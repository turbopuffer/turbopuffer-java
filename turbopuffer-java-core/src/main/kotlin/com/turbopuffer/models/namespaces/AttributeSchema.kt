...
@NoAutoDetect
class AttributeSchema @JsonCreator private constructor(
    @JsonProperty("filterable") @ExcludeMissing private val filterable: JsonField<Boolean> = JsonMissing.of(),
    @JsonProperty("full_text_search") @ExcludeMissing private val fullTextSearch: JsonField<FullTextSearch> = JsonMissing.of(),
     ...
     */
    fun fullTextSearch(): Optional<FullTextSearch> = Optional.ofNullable(fullTextSearch.getNullable("full_text_search"))
    ...
    @ExcludeMissing
    fun _filterable(): JsonField<Boolean> = filterable
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attributeSchema: AttributeSchema) =
            apply {
        ...
        /** Whether or not the attributes can be used in filters/WHERE clauses. */
        fun filterable(filterable: JsonField<Boolean>) =
            apply {
         ...
         * filterable. You can override this by setting `filterable: true`.
         */
        fun fullTextSearch(fullTextSearch: FullTextSearch) = fullTextSearch(JsonField.of(fullTextSearch))
         ...
         * filterable. You can override this by setting `filterable: true`.
         */
        fun fullTextSearch(fullTextSearch: JsonField<FullTextSearch>) =
            apply {
        ...
        fun fullTextSearch(config: FullTextSearchConfig) = fullTextSearch(FullTextSearch.ofConfig(config))
    ...
    class FullTextSearch private constructor(
        ...
        companion object {
            ...
            @JvmStatic
            fun ofBool(bool: Boolean) = FullTextSearch(bool = bool)

            /** Detailed configuration options for BM25 full-text search. */
            @JvmStatic
            fun ofConfig(config: FullTextSearchConfig) = FullTextSearch(config = config)
        }

        /**
         * An interface that defines how to map each variant of [FullTextSearch] to a value
         * of type [T].
         */
        interface Visitor<out T> {
             ...
             *
             * An instance of [FullTextSearch] can contain an unknown variant if it was
        ...
        internal class Deserializer : BaseDeserializer<FullTextSearch>(FullTextSearch::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): FullTextSearch {
              ...
              tryDeserialize(node, jacksonTypeRef<FullTextSearchConfig>()){ it.validate() }?.let {
        ...
        internal class Serializer : BaseSerializer<FullTextSearch>(FullTextSearch::class) {
            ...
            override fun serialize(value: FullTextSearch, generator: JsonGenerator, provider: SerializerProvider) {
              when {
    ...
    override fun toString() = "AttributeSchema{filterable=$filterable, fullTextSearch=$fullTextSearch, type=$type, additionalProperties=$additionalProperties}"
}
