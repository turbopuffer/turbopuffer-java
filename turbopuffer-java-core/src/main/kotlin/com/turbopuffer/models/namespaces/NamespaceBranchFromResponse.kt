...
class NamespaceBranchFromResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NamespaceBranchFromResponse].
         *
    ...
    /** A builder for [NamespaceBranchFromResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namespaceBranchFromResponse: NamespaceBranchFromResponse) = apply {
            billing = namespaceBranchFromResponse.billing
            message = namespaceBranchFromResponse.message
            rowsAffected = namespaceBranchFromResponse.rowsAffected
            status = namespaceBranchFromResponse.status
            deletedIds = namespaceBranchFromResponse.deletedIds.map { it.toMutableList() }
            patchedIds = namespaceBranchFromResponse.patchedIds.map { it.toMutableList() }
            performance = namespaceBranchFromResponse.performance
            rowsDeleted = namespaceBranchFromResponse.rowsDeleted
            rowsPatched = namespaceBranchFromResponse.rowsPatched
            rowsRemaining = namespaceBranchFromResponse.rowsRemaining
            rowsUpserted = namespaceBranchFromResponse.rowsUpserted
            upsertedIds = namespaceBranchFromResponse.upsertedIds.map { it.toMutableList() }
            additionalProperties = namespaceBranchFromResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NamespaceBranchFromResponse].
         *
         ...
         */
        fun build(): NamespaceBranchFromResponse =
    ...
    fun validate(): NamespaceBranchFromResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NamespaceBranchFromResponse &&
