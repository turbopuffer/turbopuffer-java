...
class ContainsAnyTokenFilterParams
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContainsAnyTokenFilterParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ContainsAnyTokenFilterParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(containsAnyTokenFilterParams: ContainsAnyTokenFilterParams) = apply {
            lastAsPrefix = containsAnyTokenFilterParams.lastAsPrefix
            additionalProperties = containsAnyTokenFilterParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ContainsAnyTokenFilterParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ContainsAnyTokenFilterParams =
            ContainsAnyTokenFilterParams(lastAsPrefix, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ContainsAnyTokenFilterParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContainsAnyTokenFilterParams &&
    ...
    override fun toString() =
        "ContainsAnyTokenFilterParams{lastAsPrefix=$lastAsPrefix, additionalProperties=$additionalProperties}"
}
