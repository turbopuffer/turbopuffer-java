...
private constructor(
     ...
     * ```java
     * MyClass myObject = decayParams.midpoint().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DecayParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DecayParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(decayParams: DecayParams) = apply {
            exponent = decayParams.exponent
            midpoint = decayParams.midpoint
            additionalProperties = decayParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DecayParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DecayParams =
            DecayParams(exponent, midpoint, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): DecayParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "DecayParams{exponent=$exponent, midpoint=$midpoint, additionalProperties=$additionalProperties}"
}
