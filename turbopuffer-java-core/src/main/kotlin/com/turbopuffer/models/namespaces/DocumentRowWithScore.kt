...
@NoAutoDetect
class DocumentRowWithScore @JsonCreator private constructor(
    @JsonProperty("id") @ExcludeMissing private val id: JsonField<Id> = JsonMissing.of(),
    @JsonProperty("attributes") @ExcludeMissing private val attributes: JsonField<DocumentRow.Attributes> = JsonMissing.of(),
    ...
    fun attributes(): Optional<DocumentRow.Attributes> = Optional.ofNullable(attributes.getNullable("attributes"))
    ...
    @JsonProperty("dist")
    @ExcludeMissing
    fun _dist(): JsonField<Double> = dist
    ...
    fun validate(): DocumentRowWithScore =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(documentRowWithScore: DocumentRowWithScore) =
            apply {
        ...
        /** The attributes attached to the document. */
        fun attributes(attributes: JsonField<DocumentRow.Attributes>) =
            apply {
         ...
         * other types of queries.
         */
        fun dist(dist: JsonField<Double>) =
            apply {
                this.dist = dist
            }
    ...
    override fun toString() = "DocumentRowWithScore{id=$id, attributes=$attributes, vector=$vector, dist=$dist, additionalProperties=$additionalProperties}"
}
