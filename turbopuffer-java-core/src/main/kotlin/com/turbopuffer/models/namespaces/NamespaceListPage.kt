...
/** List namespaces. */
class NamespaceListPage private constructor(
    ...
    override fun toString() = "NamespaceListPage{namespacesService=$namespacesService, params=$params, response=$response}"
    ...
    companion object {
        ...
        @JvmStatic
        fun of(namespacesService: NamespaceService, params: NamespaceListParams, response: Response) =
            NamespaceListPage(
              namespacesService,
              params,
              response,
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<NamespaceSummary> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
