...
/** List namespaces. */
class NamespaceListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): NamespaceListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namespaceListParams: NamespaceListParams) =
            apply {
    ...
    override fun toString() = "NamespaceListParams{cursor=$cursor, pageSize=$pageSize, prefix=$prefix, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
