...
class ClientListNamespacesResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClientListNamespacesResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ClientListNamespacesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(clientListNamespacesResponse: ClientListNamespacesResponse) = apply {
            namespaces = clientListNamespacesResponse.namespaces.map { it.toMutableList() }
            nextCursor = clientListNamespacesResponse.nextCursor
            additionalProperties = clientListNamespacesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClientListNamespacesResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ClientListNamespacesResponse =
    ...
    fun validate(): ClientListNamespacesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ClientListNamespacesResponse && namespaces == other.namespaces && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ClientListNamespacesResponse{namespaces=$namespaces, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
