...
/**
 * A client for interacting with the Turbopuffer REST API asynchronously. You can
 * also switch to synchronous execution via the [sync] method.
 *
...
interface TurbopufferClientAsync {
    ...
    /**
     * A view of [TurbopufferClientAsync] that provides access to raw HTTP responses
     * for each method.
     */
