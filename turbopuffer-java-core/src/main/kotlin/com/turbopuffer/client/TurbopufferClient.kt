...
/**
 * A client for interacting with the Turbopuffer REST API synchronously. You can
...
interface TurbopufferClient {
    ...
    /**
     * A view of [TurbopufferClient] that provides access to raw HTTP responses for
     * each method.
     */
